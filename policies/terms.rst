...
These Terms and Conditions of Access are presented to each user when they access the system.
We anticipate that they will change rarely, if at all.
Note that the Terms and Conditions include an agreement to the Service processing the user's personal data; in return, the Service undertakes to follow the :ref:`Personal Data and Privacy Policy <privacy>`.

Please read these Terms and Conditions.
By accessing the system you will be entering into a contract with the provider of the Isambard service.
If you do not agree to these Terms and Conditions, we will not be able to register you or allow you to use the service.

No specific copy of these Terms and Conditions will be filed under your name, but you can look at them at any time by going to this webpage.
...
- to observe the `JANET Acceptable Use Policy <https://community.ja.net/library/acceptable-use-policy>`_
- to comply with any special conditions that may apply to particular software packages

We agree:
---------

- as far as we reasonably can, to provide a 24-hour service as described on `this website <https://gw4-isambard.github.io/>`_, it being understood that there will be times when the service is unavailable, for example as a result of unexpected failures, maintenance work or upgrades
- to take reasonable steps to protect your data from being lost or corrupted. However, no backups are performed on the user data areas of the system and you are responsible for ensuring all data stored can be recovered from your own backup or regenerated in the event of a failure.
- to protect the security and privacy of the data we hold about you, as described in our :ref:`Personal Data and Privacy Policy <privacy>`
...
- that we will use the personal details which you supply to us, together with records of your use of the service, as described in our :ref:`Personal Data and Privacy Policy <privacy>`
...
- that the use of the service by nationals of certain countries is controlled by special regulations laid down by the UK Government in connection with the `Wassenaar Arrangement <http://www.wassenaar.org/>`_
...
If you have any questions about these Terms and Conditions, please send an email to `Isambard Support <isambard-support@gw4.ac.uk>`_.
